	cy_character_base.prototype.setInit_statList = function (){
		this.statList.push(
			...
			new cy_statBase('Fire Damage Suffered|,|對火抗性|,|火耐性'					, 'Fire Resistance|,|對火抗性|,|火耐性'									, 'fire_resistance'			, false	, true	, true	, -100	, '%', '', 25,  -1),
			new cy_statBase('Water Damage Suffered|,|對水抗性|,|水耐性'					, 'Water Resistance|,|對水抗性|,|水耐性'								, 'water_resistance'		, false	, true	, true	, -100	, '%', '', 25,  -1),
			new cy_statBase('Earth Damage Suffered|,|對地抗性|,|地耐性'					, 'Earth Resistance|,|對地抗性|,|地耐性'								, 'earth_resistance'		, false	, true	, true	, -100	, '%', '', 25,  -1),
			new cy_statBase('Wind Damage Suffered|,|對風抗性|,|風耐性'					, 'Wind Resistance|,|對風抗性|,|風耐性'									, 'wind_resistance'			, false	, true	, true	, -100	, '%', '', 25,  -1),
			new cy_statBase('Light Damage Suffered|,|對光抗性|,|光耐性'					, 'Light Resistance|,|對光抗性|,|光耐性'								, 'light_resistance'		, false	, true	, true	, -100	, '%', '', 25,  -1),
			new cy_statBase('Dark Damage Suffered|,|對暗耐性|,|暗耐性'					, 'Dark Resistance|,|對暗耐性|,|暗耐性'									, 'dark_resistance'			, false	, true	, true	, -100	, '%', '', 25,  -1),
			...
			new cy_statBase('Reflect|,|傷害反射|,|ダメージ反射'							, 'Reflect|,|傷害反射|,|ダメージ反射'									, 'reflect'					, false , false	, true	, 0		, '%', '', '',	1, 2),
		...
		for (let i=0; i<this.statList.length; ++i)
		{
			...
			switch ( this.statList[i].baseName )
			{
				...
				case 'natural_hp_regen'			: _cy.formula = "(10 +getV('max_hp')/25)*R +C"; break;
				...
				case 'magic_stability': _cy.formula = "getV('stability')/2 +50"; break;
				...
				case 'drop_rate'					: _cy.formula = "B + getV('Cluk')/5"; break;
				case 'motion_speed'				: _cy.formula = "(B + (getV('aspd')-1000)/180 +C)*E"; break;
				case 'cast_speed'				: _cy.formula = "(B + ( Math.min(getV('cspd'), 1000)/20 + Math.max(getV('cspd') -1000, 0)/180 ))*E"; break;
				case 'stronger_against_fire'	: _cy.formula = "B +C +25*getV('water@elements')"; break;
				case 'stronger_against_water'	: _cy.formula = "B +C +25*getV('wind@elements')"; break;
				case 'stronger_against_earth'	: _cy.formula = "B +C +25*getV('fire@elements')"; break;
