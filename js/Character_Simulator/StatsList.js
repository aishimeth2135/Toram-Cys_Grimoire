	...
	cy_character_base.prototype.setInit_statList = function (){
		try {
			...
			errorForStop_msg("Initialize Base-Stat-list false. MSG: " + String(e));
		}
		try {
			...
			errorForStop_msg("Initialize Base-Stat-formula false. MSG: " + String(e));
		}
	}
	/* (function(){
		let t_code = '';
...
try {
	...
	errorForStop_msg("Initialize Character-Equipment-Field-list false. MSG: " + String(e));
}