	cy_character_base.prototype.setInit_statList = function (){
		this.statList.push(
			...
			new cy_statBase('Earth Damage Suffered|,|抗地屬性|,|地耐性'					, 'Earth Resistance|,|對地抗性|,|地耐性'								, 'earth_resistance'		, false	, true	, true	, -100	, '%', '', 25,  -1),
			new cy_statBase('Wind Damage Suffered|,|抗風屬性|,|風耐性'					, 'Wind Resistance|,|對風抗性|,|風耐性'									, 'wind_resistance'			, false	, true	, true	, -100	, '%', '', 25,  -1),
			new cy_statBase('Light Damage Suffered|,|抗光屬性|,|光耐性'					, 'Light Resistance|,|對光抗性|,|光耐性'								, 'light_resistance'		, false	, true	, true	, -100	, '%', '', 25,  -1),
			new cy_statBase('Dark Damage Suffered|,|抗暗屬性|,|暗耐性'					, 'Dark Resistance|,|對暗耐性|,|暗耐性'									, 'dark_resistance'			, false	, true	, true	, -100	, '%', '', 25,  -1),
