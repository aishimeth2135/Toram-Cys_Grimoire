			...
			case 1:
				...
				skillNameAry = [
					[
						...
						['迅捷刺突', '鴻鵠一擲', '龍尾', '潛龍憾地', '龍牙擊', '死亡斧槍', '穿刺擊', '時空驅動', '懲戒之槍', '#斧槍要領', '#凝聚心神', '破風之勢', '逆境怒吼', '神速掌握'],['一閃', '波動刃', '三段突刺', '八相發破', '天流亂星', '畫龍點睛', '刀柄打擊', '禍斷', '斬釘截鐵', '#武士道', '#縮地法', '#雙手合持', '明鏡止水', '怪力亂神']
					],
					[
					...
					[
						...
						['#急救', '治癒術', '異常抗體', '聖域', '癒合', '生命能源', '勇氣泉源', '高速詠域', '魔力能源', '高速行動', '魔法防護', '異常防護', '神速反應'],
