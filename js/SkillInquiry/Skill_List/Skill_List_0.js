...
/*======================================================================================
  ======================================================================================*/		
	all_skilltree_type[0].STt_skilltree[0].ST_skill.push(
		...
		new the_skill(6, 	'音速斬切', 	1),		// 4
		new the_skill(7, 	'真空刃', 		6),        
		new the_skill(8, 	'風暴氣流', 	7),		// 6
...
/*======================================================================================
  ======================================================================================*/		
	all_skilltree_type[0].STt_skilltree[2].ST_skill.push(
		...
		new the_skill(12,	'_#縮時詠唱', 		11),       
		new the_skill(13,	'_#強射', 			12),	// 10
		new the_skill(14,	'マキシマイザー', 	13));
	for (var i=0;i<all_skilltree_type[0].STt_skilltree[2].ST_skill.length;i++)
	{
		if (all_skilltree_type[0].STt_skilltree[2].ST_skill[i].Sk_name != '_#魔法要領')
		{
...
/*======================================================================================
  ======================================================================================*/	
	all_skilltree_type[0].STt_skilltree[3].ST_skill.push(
		...
		new the_skill(5, 	'戰車猛擊', 	4), 	// 3
		new the_skill(6, 	'音速波動', 	1),        
		new the_skill(7, 	'震地強襲', 	6),        
		new the_skill(8, 	'三段擊', 		7), 	// 6
		new the_skill(9, 	'疾襲', 		8), 		// 3
		new the_skill(10, 	'_#格鬥要領', 	0),		// 7
		new the_skill(11, 	'_#體術鍛鍊', 	10),
		new the_skill(12, 	'經絡脈輪', 	11),		
		new the_skill(13, 	'_#乘勝追擊', 	0),		// 9
...
/*======================================================================================
  ======================================================================================*/	
	all_skilltree_type[0].STt_skilltree[5].ST_skill.push(
		...
		new the_skill(5, 	'龍牙擊', 		3),		// 3
		new the_skill(6, 	'死亡斧槍', 	1),        
		new the_skill(7, 	'穿刺擊', 		6),		// 5
		new the_skill(8, 	'時空驅動', 	7),
		new the_skill(9, 	'懲戒之槍', 	6),		// 6
		new the_skill(10, 	'_#斧槍要領', 	0),		// 7
		new the_skill(11, 	'_#凝聚心神', 	10),	// 8
		new the_skill(12, 	'破風之勢', 	0),        
		new the_skill(13, 	'逆境怒吼', 	12),	// 10
...
/*======================================================================================
  ======================================================================================*/	
	all_skilltree_type[0].STt_skilltree[6].ST_skill.push(
		...
		new the_skill(8, 	'禍斷', 		7),		// 5
		new the_skill(9, 	'斬釘截鐵', 	8),		// 6
		new the_skill(10, 	'_#武士道', 	0),		// 7
		new the_skill(11, 	'_#縮地法', 	10),	// 8
		new the_skill(12, 	'_#雙手合持', 	10),	// 9
		new the_skill(13, 	'明鏡止水', 	12),	// 10
		new the_skill(14, 	'怪力亂神', 	13));
	for (let i=0; i<=6; ++i)
	{
