try {	
	...
	======================================================================================*/	
		all_skilltree_type[0].STt_skilltree[1].ST_skill.push(
			...
			new the_skill(13, 	'_#回氣',		12	,"passive"	, "", "all[施放攻擊技能時，有${(SLv != 0) ? 5+2*SLv : 0}%恢復100MP]"),//12
	...
	======================================================================================*/	
		all_skilltree_type[0].STt_skilltree[6].ST_skill.push(
			...
			new the_skill(12, 	'_#雙手合持', 	10	, "passive"	, "noSub_Katana[accuracy#SLv%, stability#SLv, critical_rate#SLv] & noSub[accuracy#SLv%, stability#parseInt(SLv/2), critical_rate#parseInt(SLv/2)]", "noSub_Katana[暴擊發生時，傷害公式中的有效Atk提升至原本的${100+5*SLv}%]"),	// 11
	...
	showWarningMsg("<Error> Initialize Skill-list<0> false. Please contact the author. <br />" + String(e));
}