	...
	function jp_input_skillCaptionSI_2(No_STT, No_ST, No_S, No_Branch){
		...
		if (all_SI[24].SI_unit != ' sec')
		{
			all_SI[24].SI_unit = ' sec';
		}
		all_SI[27].SI_name = '';
		all_SI[28].SI_name = '';
		all_SI[29].SI_name = '';
					...
					case 0:
						switch (T_no_S)
						{
							case 1:
								...
								{
									case 0:
										all_SI[0].SI_value = 'Damage: ';
										all_SI[1].SI_value = 'Valid Atk ';
										all_SI[2].SI_value = 50 + 5*T_skillLv;
										all_SI[3].SI_value = 100 + 5*T_skillLv;
										all_SI[16].SI_value = 'Damage(Single Target)';
										all_SI[17].SI_value = 'Fast';
							...
							case 2:
								switch (No_Branch)
								{
									case 0:
										...
										all_SI[16].SI_value = 'Damage(Single Target)';
										all_SI[17].SI_value = 'Very fast';
										all_SI[20].SI_value = 1;
										all_SI[27].SI_name = 'If this skill is not avoided, within ';
										all_SI[27].SI_value = 5*parseInt((T_skillLv+6)/6);
										all_SI[27].SI_unit = '';
										all_SI[28].SI_name = ' sec Critical Rate +';
							...
							case 3:
								switch (No_Branch)
								{
									case 0:
										...
										all_SI[17].SI_value = 'Very fast';
										all_SI[20].SI_value = 1;
										all_SI[27].SI_name = 'When equipped with 1h-Sword, ';
										all_SI[27].SI_value = '';
										all_SI[27].SI_unit = '.<br />';
										all_SI[28].SI_value = 'If this skill is not avoided, you will obtain _&1_, 強化下一招技能.';
										break;
									case 1:
										all_SI[5].SI_name = 'Attack MP Recovery +';
							...
							case 6:
								switch (No_Branch)
								{
									case 0:
										...
										all_SI[3].SI_value = 100 + 5*T_skillLv;
										all_SI[16].SI_value = 'Damage(Linear AOE)';
										all_SI[17].SI_value = 'Slightly faster';
										all_SI[20].SI_value = 1;
										all_SI[22].SI_value = '自身位置-目標位置';
										all_SI[23].SI_value = 2;
										all_SI[27].SI_name = 'Crital Rate +';
										all_SI[27].SI_value = input_SI_value_bySelection('Weap', ['1hSword'],[10*T_skillLv, T_skillLv]);
										all_SI[27].SI_unit = ' of this skill.';
							...
							case 7:
								switch (No_Branch)
								{
									case 0:
										...
										all_SI[24].SI_value = 'About 1~2';
										all_SI[27].SI_value = 'This skill never Crit. ';
										all_SI[28].SI_name = 'If this skill is not avoided, Critical Damage +[';
										all_SI[28].SI_value = input_SI_value_bySelection('Weap', ['1hSword'],[(T_skillLv+1)/2 + '+(Dex ×2%)', (T_skillLv+1)/4 + '+(Dex ×1%)']);
										all_SI[28].SI_unit = '] within ' + (2+T_skillLv) + 'sec. (Round down to an integer)';
										break;
								}
								break;
							case 8:
								...
								{
									case 0:
										all_SI[5].SI_value = '向目標發射一道_&1_, _&1_將在造成傷害後消失, 並隨即於目標位置產生_&2_.';
										all_SI[17].SI_value = 'Slower';
										break;
									case 1:
										all_SI[0].SI_value = 'Damage: ';
										all_SI[1].SI_value = 'Valid Atk ';
										...
										break;
									case 2:
										all_SI[0].SI_value = 'Each time the Damage: ';
										all_SI[1].SI_value = 'Valid Atk ';
							...
							case 11:
								...
								{
									case 0:
										all_SI[5].SI_name = 'ASPD +';
										all_SI[5].SI_value = 10*T_skillLv;
										all_SI[5].SI_unit = '.';
										all_SI[6].SI_name = 'ASPD +';
					...
					case 1:
						switch (T_no_S)
						{
							...
							case 4:
								...
								{
									case 0:
										all_SI[0].SI_value = 'Each time the Damage: (分開判定)';
										all_SI[1].SI_value = 'Valid Atk ';
							...
							case 7:
								switch (No_Branch)
								{
									case 0:
										...
										all_SI[27].SI_name = '<br />If this skill is not avoided, 10秒內自身穩定度+';
							...
							case 8:
								switch (No_Branch)
								{
									case 0:
										...
										all_SI[27].SI_name = '<br />If this skill is not avoided, 10秒內自身Hit +';
					...
					case 2:
							...
							case 4:
								switch (No_Branch)
								{
									case 0:
										...
										all_SI[27].SI_value = '<br />施放完畢後, you will obtain _&1_的狀態.強化下一招技能.';
							...
							case 13:
								switch (No_Branch)
								{
									...
									case 1:
										...
										all_SI[16].SI_value = 'Normal Attack';
										all_SI[17].SI_value = 'Normal Attack';
										all_SI[20].SI_value = 1;
						...
						switch (T_no_S)
						{
							...
							case 4:
								switch (No_Branch)
								{
									...
									case 1:
										...
										all_SI[2].SI_value = 100 + 10*T_skillLv;
										all_SI[3].SI_value = 100 + 15*T_skillLv;
										all_SI[16].SI_value = 'Additional Damage(Single Target)';
										all_SI[20].SI_value = 1;
							...
							case 14:
								...
								{
									case 0:
										all_SI[5].SI_name = '使「乘勝追擊」追擊的傷害提升(Valid Atk ×';
										all_SI[5].SI_value = 5*T_skillLv;
										all_SI[5].SI_unit = '%).';
					...
					case 4:
						switch (T_no_S)
						{
							...
							case 3:
								switch (No_Branch)
								{
									...
									case 1:
										...
										break;
									case 2:
										all_SI[0].SI_value = 'Each time the Damage: (每5個傷害視為一次、分開判定)';
										all_SI[1].SI_value = 'Valid Atk ';
										all_SI[2].SI_value = 50 + 5*T_skillLv;
							...
							case 4:
								...
								{
									case 0:
										all_SI[0].SI_value = 'Total damage: (共用判定)';
										all_SI[1].SI_value = 'Valid Atk ';
										all_SI[2].SI_value = 200 + 20*T_skillLv;
									...
									case 1:
										...
										break;
									case 2:
										all_SI[5].SI_value = 'Inflicts 999999999 damage to the target.';
										all_SI[16].SI_value = 'Additional Damage(Single Target)';
										all_SI[20].SI_value = 1;
										break;
								}
							...
							case 5:
								switch (No_Branch)
								{
									...
									case 1:
										...
										all_SI[5].SI_unit = '%.<br />格檔成功後you will obtain _&2_.';
										all_SI[16].SI_value = '效果狀態';
					...
					case 6:
						switch (T_no_S)
						{
							...
							case 2:
								...
								{
									case 0:
										all_SI[0].SI_value = 'Total damage: (三次分開判定)';
										all_SI[1].SI_value = 'Valid Atk ';
									...
									case 1:
										...
										break;
									case 2:
										all_SI[5].SI_name = '第一下傷害為(Valid Atk +';
							...
							case 3:
								switch (No_Branch)
								{
									case 0:
										...
										all_SI[17].SI_value = 'Slower';
										all_SI[20].SI_value = 3;
										all_SI[27].SI_value = 'If this skill is not avoided, you will obtain _&1_效果, 強化下一招技能.';
										break;
									case 1:
							...
							case 9:
								switch (No_Branch)
								{
									...
									case 2:
										...
										all_SI[16].SI_value = 'Additional Damage(Single Target)';
										all_SI[20].SI_value = 1;
										all_SI[27].SI_value = '此Additional Damage會在技能施放完畢後多一個斬擊的動作, 才造成傷害, 而非直接多一個傷害.';
										break;
								}
								break;
							case 10:
							...
							case 11:
								switch (No_Branch)
								{
									case 0:
										...
										break;
									case 1:
										all_SI[5].SI_name = '以極快的速度貼近目標.貼近期間若進行移動, 可手動停下.<br /> 若經由普通攻擊(普攻)觸發, 且沒有手動停止, 則該次普攻的Attack MP Recovery +';
										all_SI[5].SI_value = 2.5*T_skillLv;
										all_SI[5].SI_unit = '.';
										all_SI[6].SI_value = '';
										all_SI[16].SI_value = '被動效果';
							...
							case 12:
								...
								{
									case 0:
										all_SI[5].SI_name = '只有副手無裝備時, 才享有此技能的效果.<br />Hit +';
										all_SI[5].SI_value = T_skillLv;
										all_SI[5].SI_unit = '%.';
							...
							case 14:
								switch (No_Branch)
								{
									case 0:
										...
										all_SI[6].SI_value = '?';
										all_SI[6].SI_unit = '.';
										all_SI[7].SI_name = '普攻攻擊傷害提升(Valid Atk ×';
										all_SI[7].SI_value = '?';
										all_SI[7].SI_unit = '%).';
										all_SI[17].SI_value = 'Fast';
										all_SI[16].SI_value = '狀態加成';
										...
										all_SI[28].SI_value = '<br />於技能作用期間內所施放的畫龍點睛, you will obtain _&1_效果.';
										break;
									case 1:
						...
						switch (T_no_S)
						{
							...
							case 4:
								switch (No_Branch)
								{
									...
									case 1:
										all_SI[0].SI_value = 'Damage: ';
										all_SI[1].SI_value = input_SI_value_bySelection('Au', ['盾牌'], ['Valid Atk +盾精煉值×60', 'Valid Atk ']);
										all_SI[2].SI_value = 10*T_skillLv;
										all_SI[3].SI_value = 10*T_skillLv;
										all_SI[16].SI_value = 'Damage(Single Target)';
						...
						switch (T_no_S)
						{
							case 1:
								switch (No_Branch)
								{
									case 0:
										all_SI[0].SI_value = 'Damage: ';
										all_SI[5].SI_value = 'Valid Atk ×' + (10 + 4*T_skillLv) + '% +小刀Atk';
										all_SI[16].SI_value = 'Damage(Single Target)';
										all_SI[17].SI_value = 'Fast';
										all_SI[20].SI_value = 1;
							...
							case 2:
								switch (No_Branch)
								{
									case 0:
										all_SI[0].SI_value = 'Total damage: (共用判定)';
										all_SI[1].SI_value = 'Valid Atk +小刀Atk×20%';
										all_SI[2].SI_value = 10 + T_skillLv;
							...
							case 3:
								switch (No_Branch)
								{
									case 0:
										all_SI[0].SI_value = 'Each time the Damage: (共用判定)';
										all_SI[1].SI_value = 'Valid Atk +小刀Atk';
							...
							case 5:
								switch (No_Branch)
								{
									case 0:
										all_SI[0].SI_value = 'Damage: ';
										all_SI[1].SI_value = 'Valid Atk +(Dex×50%+Agi×2)';
							...
							case 7:
								switch (No_Branch)
								{
									...
									case 1:
										all_SI[0].SI_value = 'Damage: ';
										all_SI[5].SI_value = 'Valid Atk ×10% +小刀Atk';
										all_SI[16].SI_value = 'Additional Damage(Single Target)';
										all_SI[20].SI_value = 1;
							...
							case 8:
								switch (No_Branch)
								{
									case 0:
										...
										all_SI[5].SI_value = 5*T_skillLv;
										all_SI[5].SI_unit = '%.';
										all_SI[6].SI_value = '使得「無影刃」的無影追襲傷害提升(Valid Atk ×10%).';
										all_SI[16].SI_value = '被動效果';
					...
					case 3:
						switch (T_no_S)
						{
							...
							case 3:
								...
								{
									case 0:
										all_SI[5].SI_value = '施放完畢後, you will obtain _&1_狀態._&1_期間角色無法作任何動作.';
										all_SI[16].SI_value = '效果';
										all_SI[17].SI_value = 'Fast';
										break;
									case 1:
