	...
	cy_enchantEquipment_base.prototype.lvPotentialMax = 16;
	...
	cy_enchantEquipment_base.prototype.enchantDefaultFrame_list.push(
		new cy_enchantDefaultFrame('Physical'				, 'Physical(Normal)|,|物理職、一般|,|物理火力無属性', false, 'noItemCategory@_atk#7% & critical_damage#16 & critical_rate#16 & critical_rate#16% & negative@_def#-7% & negative@_mdef#-7%', 0, ['', '', '', '', 'Critical', 'Critical'], '+1 +3 -2'),
		new cy_enchantDefaultFrame('Physical'				, '', false, 'noItemCategory@_atk#7% & critical_damage#2% & critical_damage#16 & critical_rate#16 & negative@_def#-7% & negative@_mdef#-7%', 0, ['', '', '', '', 'Critical', 'Critical'], '+1 +3 -2'),
		new cy_enchantDefaultFrame('Physical'				, '', false, 'noItemCategory@_atk#7% & noItemCategory@_str#2% & critical_damage#16 & critical_rate#16 & negative@_def#-7% & negative@_mdef#-7%', 0, ['', '', '', '', 'Critical', 'Critical'], '+1 +1 +2 -2'),
		new cy_enchantDefaultFrame('Physical'				, '', false, 'noItemCategory@_atk#7% & critical_damage#7% & critical_damage#16 & negative@_natural_hp_regen#-7% & negative@_mdef#-7% & negative@_dodge#-7', 0, ['', '', '', '', 'Critical', 'Critical'], 'atk%, cd%, cd'),
		...
		new cy_enchantDefaultFrame('Physical_Elements'		, '', false, 'noItemCategory@_fire_base@elements#1 & noItemCategory@_stronger_against_earth#14 & critical_damage#2% & critical_damage#16 & negative@_natural_hp_regen#-7% & negative@_dodge#-7', 0, ['', '', '', '', 'Critical', 'Critical'], '+1 +1 +2 -2'),
		new cy_enchantDefaultFrame('Physical_Elements'		, '', false, 'noItemCategory@_fire@elements#1 & noItemCategory@_stronger_against_earth#14 & noItemCategory@_critical_rate#16 & negative@_natural_hp_regen#-7% & negative@_mdef#-7% & negative@_dodge#-7', 0, ['', '', '', '', '', ''], '+1 +1 +1 -1 -1 -1'),
		...
		new cy_enchantDefaultFrame('Physical_Elements'		, '', false, 'noItemCategory@_stronger_against_earth#14 & noItemCategory@_atk#2% & critical_rate#16 & critical_damage#16 & negative@_natural_hp_regen#-7% & negative@_dodge#-7', 0, ['', '', '', '', 'Critical', 'Critical'], '+1 +1 +2 -2'),
		new cy_enchantDefaultFrame('Physical_Elements'		, '', false, 'noItemCategory@_stronger_against_earth#14 & noItemCategory@_atk#7% & noItemCategory@_dex#1% & noItemCategory@_critical_rate#16 & negative@_natural_hp_regen#-7% & negative@_dodge#-7', 0, ['', '', '', '', '', ''], '+1 +1 +1 +1 -1 -1'),
		new cy_enchantDefaultFrame('Physical_Elements'		, '', false, 'noItemCategory@_stronger_against_earth#14 & critical_damage#16 & critical_rate#16 & critical_rate#16% & negative@_def#-7% & negative@_mdef#-7%', 0, ['', '', '', '', 'Critical', 'Critical'], '+1 +3 -2'),
		...
		new cy_enchantDefaultFrame('Tank'					, '', false, 'noItemCategory@_vit#7% & noItemCategory@_aggor#10 & noItemCategory@_critical_rate#16 & negative@_natural_hp_regen#-7% & negative@_mdef#-7% & negative@_dodge#-7', 0, ['', '', '', '', '', ''], '+1 +1 +1 -1 -1 -1'),
		new cy_enchantDefaultFrame('Tank'					, '', false, 'noItemCategory@_fire_resistance#14 & noItemCategory@_aggor#10 & noItemCategory@_critical_rate#16 & negative@_natural_hp_regen#-7% & negative@_mdef#-7% & negative@_dodge#-7', 0, ['', '', '', '', '', ''], '+1 +1 +1 -1 -1 -1'),
		...
		new cy_enchantDefaultFrame('body_Physical'			, 'Physical(Normal)|,|物理職、一般|,|物理火力無属性', true, 'critical_damage#7% & critical_damage#16 & critical_rate#16 & critical_rate#16% & negative@_matk#-7% & negative@_accuracy#-7', 1, ['', '', '', '', 'Critical', 'Critical'], 'cd%, cd, c, c%', 31),
		new cy_enchantDefaultFrame('body_Physical'			, '', false, 'noItemCategory@_dex#7% & critical_damage#16 & critical_rate#16 & critical_rate#16% & negative@_matk#-7% & negative@_accuracy#-7', 1, ['', '', '', '', 'Critical', 'Critical'], '+1 +3 -1 -1'),
		new cy_enchantDefaultFrame('body_Physical'			, '', false, 'noItemCategory@_str#2% & critical_damage#7% & critical_damage#16 & critical_rate#16 & negative@_matk#-7% & negative@_accuracy#-7', 1, ['', '', '', '', 'Critical', 'Critical'], '+1 +3 -1 -1'),
