	...
	cy_enchantEquipment_base.prototype = {
		doublePotentialList: [
		...
		isFull: function(){
			for (let i=0; i<this.abilityItem.length; ++i)
			{
				if ( !this.abilityItem[i].exist )
					return false;
			}
			return true;
		},
		
		getBestDistribution: function(N, a, b, maxAry = ['none', 'none'], minAry = ['none', 'none']){
		...
		searchItemListByName: function(name){
		...
		get_curAdditionalRate: function(expInput = 'none'){
		...
		item_addValue: function(item, value, test = false){
		...
		findItemByName: function (itemName, type, categoryConfirm = false, ingnoreNo = 'none'){
		...
		nextStep: function(testValue = 'none'){
		...
		getMaterialCostBase: function(_potentialUnit, name = ""){
			let _costUnit = 0;
		...
		getMaterialCost: function(onlyText = false){
	...
	cy_enchantAbilityItem.prototype = {
		confirmRange: function(type = 'both', inputValue = 'none'){
		...
		get_show: function(getSetting = false, inputValue = 'none', langControl = 'none'){
		...
		setInit: function(tbase = 'none', ttype = 0){
		...
		setSettingValue: function(tvalue = 0){
		...
		getPotentialUnit: function(calcDouble = true){
		...
		getStepStr: function(_value = 'none'){
	...
	cy_enchantDefaultFrame.prototype = {
		get_show: function(){
			let _text = '';
